...
const PosterOneElementGenerator = () => {
        ...
        <div className="scale-[25%] origin-top-left ">
          ...
          >
            ...
            <PosterGrid sideText={date}>
              ...
              <div
                className="w-[1476px] aspect-square border-black border-y-[3px] relative"
...
export default PosterOneElementGenerator;
